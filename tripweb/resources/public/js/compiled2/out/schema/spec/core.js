 ...
 */
schema.spec.core.sub_checker = (function schema$spec$core$sub_checker(p__32542,p__32543){
var map__32548 = p__32542;
var map__32548__$1 = ((((!((map__32548 == null)))?((((map__32548.cljs$lang$protocol_mask$partition0$ & (64))) || (map__32548.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32548):map__32548);
var schema__$1 = cljs.core.get.call(null,map__32548__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var error_wrap = cljs.core.get.call(null,map__32548__$1,new cljs.core.Keyword(null,"error-wrap","error-wrap",-1295833514));
...
var params = map__32549__$1;
var subschema_checker = cljs.core.get.call(null,map__32549__$1,new cljs.core.Keyword(null,"subschema-checker","subschema-checker",1137701360));
var cache = cljs.core.get.call(null,map__32549__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
return schema.spec.core.with_cache.call(null,cache,schema__$1,((function (map__32548,map__32548__$1,schema__$1,error_wrap,map__32549,map__32549__$1,params,subschema_checker,cache){
return (function (d){
return ((function (map__32548,map__32548__$1,schema__$1,error_wrap,map__32549,map__32549__$1,params,subschema_checker,cache){
return (function (x){
return cljs.core.deref.call(null,d).call(null,x);
});
;})(map__32548,map__32548__$1,schema__$1,error_wrap,map__32549,map__32549__$1,params,subschema_checker,cache))
});})(map__32548,map__32548__$1,schema__$1,error_wrap,map__32549,map__32549__$1,params,subschema_checker,cache))
,((function (map__32548,map__32548__$1,schema__$1,error_wrap,map__32549,map__32549__$1,params,subschema_checker,cache){
return (function (){
var sub = subschema_checker.call(null,schema__$1,params);
if(cljs.core.truth_(error_wrap)){
return ((function (sub,map__32548,map__32548__$1,schema__$1,error_wrap,map__32549,map__32549__$1,params,subschema_checker,cache){
return (function (x){
...
;})(sub,map__32548,map__32548__$1,schema__$1,error_wrap,map__32549,map__32549__$1,params,subschema_checker,cache))
} else {
return sub;
}
});})(map__32548,map__32548__$1,schema__$1,error_wrap,map__32549,map__32549__$1,params,subschema_checker,cache))
...
//# sourceMappingURL=core.js.map?rel=1484804402746